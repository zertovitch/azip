...
package AZip_GWin.Columns is
  ...
  procedure Set_column_width_to_main_options (Window : in out MDI_Child_Type; topic : Entry_topic; new_width : Natural);
  ...
  --
  procedure Get_all_column_widths_from_main_options (Window : in out MDI_Child_Type);
  procedure Set_all_column_widths_to_main_options (Window : in out MDI_Child_Type);
