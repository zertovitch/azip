...
package AZip_GWin.Tabs is
  ...
  overriding procedure On_Change (Control : in out AZip_Tab_Bar_Type);
  overriding procedure On_Create (Control : in out AZip_Tab_Bar_Type);
  ...
  overriding procedure On_Middle_Click (Control : in out AZip_Tab_Bar_Type);
  overriding procedure On_Right_Click (Control : in out AZip_Tab_Bar_Type);

  overriding procedure Delete_Tab (Control : in out AZip_Tab_Bar_Type; Where : in Integer);

  function Tab_Index (Control : in out AZip_Tab_Bar_Type; ID : ID_Type) return Integer;
