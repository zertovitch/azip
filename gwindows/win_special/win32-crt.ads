...
--  which are Ada packages which interface to the C runtime system
--  and which require a runtime system from Microsoft or GNU or
--  another source in order to work.
--  "crt" is a Microsoft abbreviation for "C runtime".
--  **************************************************************
